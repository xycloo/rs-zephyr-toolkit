...
use soroban_sdk::{
    contract, contractimpl, contractmeta, contracttype, Address, BytesN, ConversionError, Env,
...
pub struct InitializeEvent {
    ...
    token_a: Address,
    token_b: Address,
    share_contract: Address,
}

#[cfg(feature = "mercury")]
#[contracttype]
#[derive(Retroshade)]
pub struct ShareIdEvent {
    share_id: Address,
}
...
impl LiquidityPoolTrait for LiquidityPool {
    ...
    fn withdraw(e: Env, to: Address, share_amount: i128, min_a: i128, min_b: i128) -> (i128, i128) {
        ...
        WithdrawEvent {
            ...
            out_a,
            out_b,
            new_reserve_a: balance_a - out_a,
            new_reserve_b: balance_b - out_b,
        }
        .emit(&e);
